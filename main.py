...
def load_config(mode=None):
    ...
    parser.add_argument('--path', '--checkpoints', type=str, default='./checkpoints/celeba-hq-im', help='model checkpoints path (default: ./checkpoints)')
    ...
    if mode == 2:
        ...
        parser.add_argument('--mask', default='./mask.png',
                            type=str, help='path to the masks directory or a mask file')
        parser.add_argument('--edge', default='./edge.png', type=str, help='path to the edges directory or an edge file')
